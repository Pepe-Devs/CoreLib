package com.pepedevs.corelib.utils.reflection.annotation;
...
/**
 * Resolves the annotated {@link ClassWrapper} or {@link java.lang.Class} field to the first
 * matching class name.
 */
...
public @interface Class {
    ...
    /**
     * Name of the class. Use <code>{nms}.MyClass</code> for NMS classes, or <code>{obc}.MyClass
     * </code> for OBC classes. Use <code>&gt;</code> or <code>&lt;</code> as a name prefix in
