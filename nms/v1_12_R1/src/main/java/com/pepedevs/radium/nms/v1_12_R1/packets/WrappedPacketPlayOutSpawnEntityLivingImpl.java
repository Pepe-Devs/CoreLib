...
import com.pepedevs.radium.nms.packets.WrappedPacketPlayOutSpawnEntityLiving;
...
public class WrappedPacketPlayOutSpawnEntityLivingImpl implements WrappedPacketPlayOutSpawnEntityLiving {
    ...
    private static final FieldAccessor DATA_WATCHER_FIELD = new FieldResolver(PacketPlayOutSpawnEntityLiving.class).resolveAccessor("m");
    ...
    public WrappedPacketPlayOutSpawnEntityLivingImpl(WrappedPacketDataSerializer serializer, Object dataWatcher) {
        ...
        this.entityType = EntityType.fromId(dataSerializer.g());
