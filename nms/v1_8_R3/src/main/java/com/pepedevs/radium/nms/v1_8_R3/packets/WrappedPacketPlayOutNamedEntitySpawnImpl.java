...
import com.pepedevs.radium.nms.packets.WrappedPacketPlayOutNamedEntitySpawn;
...
public class WrappedPacketPlayOutNamedEntitySpawnImpl implements WrappedPacketPlayOutNamedEntitySpawn {
    ...
    private static final FieldAccessor DATA_WATCHER_FIELD = new FieldResolver(PacketPlayOutNamedEntitySpawn.class).resolveAccessor("i");
    ...
    public WrappedPacketPlayOutNamedEntitySpawnImpl(WrappedPacketDataSerializer serializer, Object dataWatcher) {
        ...
        short s = dataSerializer.readShort();
        this.mainHandItem = s == 0 ? null : CraftItemStack.asBukkitCopy(new net.minecraft.server.v1_8_R3.ItemStack(Item.getById(s)));
        this.dataWatcher = (DataWatcher) dataWatcher;
    }
    ...
    public WrappedPacketDataSerializer buildData() {
        ...
        serializer.serializeVarInt(entityId)
                ...
                .serializeShort(this.mainHandItem == null ? 0 : Item.getId(CraftItemStack.asNMSCopy(this.mainHandItem).getItem()));
        try {
