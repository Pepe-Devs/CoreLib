...
public class NMSBridge {
    ...
    static {
        Class<?> clazz = null;
        try {
            clazz = Class.forName("com.pepedevs.corelib.nms." + Version.SERVER_VERSION.name() + ".NMSProviderImpl");
        ...
        Class<?> clazz2 = null;
        try {
            clazz2 = Class.forName("com.pepedevs.corelib.nms." + Version.SERVER_VERSION.name() + ".PacketProviderImpl");
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
        }
